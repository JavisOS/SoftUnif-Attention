...
id_relation_map = ID_RELATION_MAP_21_WITH_NOTHING
all_possible_transitives = ALL_POSSIBLE_TRANSITIVES_20
...
class CLUTRRDataset:
  ...
  def __getitem__(self, i):
    ...
    gt_relations = safe_literal_eval(self.data[i][8], default=None)
    if gt_relations is None:
      raise ValueError(f"Invalid gt_relations format: {self.data[i][8]}")
