...
from clutrr.config.relation_schema import RELATION_ID_MAP_20 as relation_id_map
...
def build_parser():
  ...
  default_data_dir = os.path.abspath(os.path.join(os.path.abspath(__file__), '../../data'))
  parser.add_argument("--data_dir", type=str, default=default_data_dir)
  parser.add_argument("--gpt_dir", type=str, default="gpt_composition_rules_prompt_Mary_D03")
...
if __name__ == "__main__":
  ...
  gpt_dir = args.gpt_dir if os.path.isabs(args.gpt_dir) else os.path.join(data_dir, args.gpt_dir)
  gt_path = args.gt_path or os.path.join(data_dir, 'gt_rules.csv')
  gpt_path = args.output_path or os.path.join(data_dir, 'gpt_rules.json')
