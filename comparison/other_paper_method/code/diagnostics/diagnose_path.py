...
from comparison.other_paper_method.code.analysis.baseline_roberta_analysis import (
    CLUTRRBaseline,
    relation_id_map,
    id_to_relation,
)
...
class PathDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        try:
            ...
            types = safe_literal_eval(row[12], default=None)
            if edges is None or types is None:
